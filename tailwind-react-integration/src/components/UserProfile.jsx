function UserProfile() {
  return (
    <div
      className="user-profile bg-gray-100 p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg p-4 sm:p-4 md:p-8 max-w-xs
            sm:max-w-xs md:max-w-sm my-10 md:my-20 hover:shadow-xl transition-shadow duration-300 ease-in-out"
    >
      <img
